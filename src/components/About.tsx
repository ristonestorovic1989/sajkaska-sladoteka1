...
const About = () => {
  return (
    <section
      id="o-nama"
      className="py-24 md:py-32 bg-gradient-premium relative overflow-hidden"
    >
      {/* Decorative blobs */}
      ...
      <div className="container max-w-5xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-display text-foreground mb-6">
            Slatka tradicija sa{" "}
            <span className="italic text-primary">ljubavlju</span>
          </h2>
            ...
            >
              <motion.div
                ...
                className={`w-16 h-16 mx-auto mb-5 rounded-2xl flex items-center justify-center transition-shadow duration-500 ${
                  item.color === "primary"
                    ? "bg-rose-light glow-pink"
                    : item.color === "accent"
                      ? "bg-mint-light glow-mint"
                      : "bg-blue-light"
                }`}
              >
                <item.icon
