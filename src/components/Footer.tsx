...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden bg-foreground py-12 md:py-16">
        ...
        >
          <div className="mb-8 grid gap-8 md:grid-cols-2 md:gap-10">
            <div className="text-center md:text-left">
              ...
              <p className="mb-6 text-sm font-body text-primary-foreground/50">
              ...
              <a
                ...
                className="mt-4 inline-block text-xs font-body text-primary-foreground/60 transition-colors hover:text-primary md:mt-3"
              >
                sajkaskasladoteka@gmail.com
              </a>
            </div>

            <div className="text-center md:text-left">
              <p className="mb-4 text-xs font-body tracking-[0.16em] uppercase text-primary-foreground/50">
                Podaci o preduzetniku
              </p>
              <div className="space-y-3 text-sm font-body leading-6 text-primary-foreground/75">
                <p>
                  Naziv: Jelena Deronjić PR Proizvodnja torti i kolača ŠAJKAŠKA
                  SLADOTEKA Šajkaš
                </p>
                <p>Adresa: Nikole Tesle 41, 21244 Šajkaš, Srbija</p>
                <p>PIB: 114539134 | MB: 67657772</p>
              </div>
            </div>
          </div>
          <div className="mx-auto mb-6 h-px w-16 bg-primary-foreground/10" />
          <p className="flex items-center justify-center gap-1 text-center text-xs font-body text-primary-foreground/30">
      ...
      <p className="mt-4 text-center text-[10px] font-body tracking-[0.08em] uppercase text-primary-foreground/35">
        Dizajn i izrada:{" "}
        <a
